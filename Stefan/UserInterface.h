 ...
 */
class UserInterface         //ganze klasse heist userinterface
{
public:
    /**
    ...
    private:
        ...
        bool empty;
        Color color;        //color mit klasse struktur color red yellow
                            //enum also 1 ist rot 2 ist gelb
    public:
        /** The constructor initalizes the Field as empty */
        //ruft klasse wieder auf und bestimmt empt gleich mit true
        //hier muss feld deklariert werdem
        Field() :
                empty(true), color()
        {
    ...
    //rowtype ist ein array mit 7 elementen die struktur von field haben
    //also 7 mal struktur empty u farbe kann darauf geschrieben werden
