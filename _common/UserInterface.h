...
public:
    ...
    private:
        ...
        Color color;
    public:
        /** The constructor initializes the Field as empty */
        Field() :
                empty(true), color()
        {
        }
    ...
    /**
     * @brief Datatype to represent a row of Fields
     * @details Index 0 means left-most Field in a row
     */
    typedef std::array<Field, 7> RowType;

    /**
     * @brief Datatype to represent a grid of Fields
     * @details Index 0 means top-most Row in the grid
     */
